...
#SBATCH --job-name=ModernTCN_electricity_D3
#SBATCH --output=/pfs/work9/workspace/scratch/ma_skral-SK_thesis_2025/Thesis_MTSF/slurm/ModernTCN_electricity_D3.out
    ...
    do
        ...
        do
            python -u run_longExp.py \
                ...
                --delta_factor 0.5 \
                >logs/LongForecasting/$model_name'_'electricityD3_$seq_len'_'$pred_len.log
        done
    done
done