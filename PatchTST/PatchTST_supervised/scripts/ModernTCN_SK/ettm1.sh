...
#SBATCH --job-name=ModernTCN_ETTm1
#SBATCH --output=/pfs/work9/workspace/scratch/ma_skral-SK_thesis_2025/Thesis_MTSF/slurm/ModernTCN_ETTm1.out
    ...
    do
        ...
        do
            python -u run_longExp.py \
                ...
                >logs/LongForecasting/$model_name'_ETTm1_'$seq_len'_'$pred_len.log
        done
    done
done
