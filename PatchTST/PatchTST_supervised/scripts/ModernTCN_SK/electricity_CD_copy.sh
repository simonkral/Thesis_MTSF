...
#SBATCH --job-name=ModernTCN_electricity_cd2
#SBATCH --output=/pfs/work9/workspace/scratch/ma_skral-SK_thesis_2025/Thesis_MTSF/slurm/ModernTCN_electricity_cd2.out
    ...
    do
        ...
        do
            python -u run_longExp.py \
                ...
                >logs/LongForecasting/$model_name'_'electricity_cd2_$seq_len'_'$pred_len.log
        done
    done
done