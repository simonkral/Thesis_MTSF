...
#SBATCH --job-name=ModernTCN_electricity_D5
#SBATCH --output=/pfs/work9/workspace/scratch/ma_skral-SK_thesis_2025/Thesis_MTSF/slurm/ModernTCN_electricity_D5.out
    ...
    do
        ...
        do
            python -u run_longExp.py \
                ...
                --delta_factor 0.5 \
                >logs/LongForecasting/$model_name'_'electricityD5_$seq_len'_'$pred_len.log
        done
    done
done