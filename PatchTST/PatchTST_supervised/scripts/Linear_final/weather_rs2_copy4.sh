...
#SBATCH --job-name=Linear_final_weather_rs6
#SBATCH --output=/pfs/work9/workspace/scratch/ma_skral-SK_thesis_2025/Thesis_MTSF/slurm/Linear_final_weather_rs6.out
        ...
        do 
            ...
            do
                python -u run_longExp.py \
                    ...
                    >logs/LongForecasting/$model_name'_'Weather_rs6_$seq_len'_'$pred_len.log
            done
        done
    done
done