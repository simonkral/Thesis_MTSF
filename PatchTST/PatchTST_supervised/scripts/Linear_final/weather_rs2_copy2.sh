...
#SBATCH --job-name=Linear_final_weather_rs4
#SBATCH --output=/pfs/work9/workspace/scratch/ma_skral-SK_thesis_2025/Thesis_MTSF/slurm/Linear_final_weather_rs4.out
        ...
        do 
            ...
            do
                python -u run_longExp.py \
                    ...
                    >logs/LongForecasting/$model_name'_'Weather_rs4_$seq_len'_'$pred_len.log
            done
        done
    done
done